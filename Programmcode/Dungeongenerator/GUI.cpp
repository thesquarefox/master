...
void DunGen::CGUI::ErstelleMenue()
{
	...
	toolbar->addButton(_GUI_ID_BUTTON_GAENGE_, L"   Gänge   ");
...
void DunGen::CGUI::ErstelleFenster_Dateizugriff_Einstellungen()
{
	...
	GUIEnvironment->addCheckBox(true,irr::core::rect<irr::s32>(10,40,240,60),fenster,_GUI_ID_CHECKBOX_DATEI_EINSTELLUNGEN_FRAKTALPARAMETER_,L"L-System inklusive zugehöriger Parameter");
	...
	GUIEnvironment->addCheckBox(true,irr::core::rect<irr::s32>(10,100,240,120),fenster,_GUI_ID_CHECKBOX_DATEI_EINSTELLUNGEN_GAENGE_,L"Gänge-Einstellungen");
...
void DunGen::CGUI::ErstelleFenster_Dateizugriff_Ergebnisse()
{
	...
	GUIEnvironment->addStaticText(L"Generiertes Dreiecksnetz der Höhle:", irr::core::rect<irr::s32>(10,165,999,999), false, false, fenster);
...
void DunGen::CGUI::ErstelleFenster_FraktalEditor()
{
	...
	GUIEnvironment->addStaticText(L"Min. Länge:", irr::core::rect<irr::s32>(10,245,999,999), false, false, fenster);
	GUIEnvironment->addEditBox(L"", irr::core::rect<irr::s32>(80,240,120,260), true, fenster, _GUI_ID_EDITBOX_STARTSTRING_MINLAENGE_);
	GUIEnvironment->addStaticText(L"Max. Länge:", irr::core::rect<irr::s32>(130,245,999,999), false, false, fenster);
	GUIEnvironment->addEditBox(L"", irr::core::rect<irr::s32>(200,240,240,260), true, fenster, _GUI_ID_EDITBOX_STARTSTRING_MAXLAENGE_);
	GUIEnvironment->addButton(irr::core::rect<irr::s32>(80,265,240,280),fenster,_GUI_ID_BUTTON_ZUFALLSSTART_,L"Zufälliger Startstring");
	...
	GUIEnvironment->addStaticText(L"Min. Länge:", irr::core::rect<irr::s32>(10,365,999,999), false, false, fenster);
	GUIEnvironment->addEditBox(L"", irr::core::rect<irr::s32>(80,360,120,380), true, fenster, _GUI_ID_EDITBOX_SYMBOLERSETZUNG_MINLAENGE_);
	GUIEnvironment->addStaticText(L"Max. Länge:", irr::core::rect<irr::s32>(130,365,999,999), false, false, fenster);
	...
	GUIEnvironment->addButton(irr::core::rect<irr::s32>(10,385,155,400),fenster,_GUI_ID_BUTTON_REGELHINZUFUEGEN_,L"Regel hinzufügen");
	GUIEnvironment->addButton(irr::core::rect<irr::s32>(155,385,300,400),fenster,_GUI_ID_BUTTON_ZUFALLSREGEL_,L"Zufällige Regel hinzufügen");
	...
	GUIEnvironment->addButton(irr::core::rect<irr::s32>(10,505,300,520),fenster,_GUI_ID_BUTTON_REGELNLOESCHEN_,L"Regeln löschen");
	...
	// Erstellung
	GUIEnvironment->addStaticText(L"Gewünschte Iterationsstufe:", irr::core::rect<irr::s32>(10,555,999,999), false, false, fenster);
...
void DunGen::CGUI::ErstelleFenster_VoxelHoehle()
{
	...
	GUIEnvironment->addButton(irr::core::rect<irr::s32>(10,165,240,180),fenster,_GUI_ID_BUTTON_EROSIONSSCHRITT_HINZUFUEGEN_,L"Füge Erosionsschritt hinzu");
	...
	GUIEnvironment->addButton(irr::core::rect<irr::s32>(10,280,240,295),fenster,_GUI_ID_BUTTON_EROSIONSSCHRITTE_LOESCHEN_,L"Erosionsschritte löschen");
	...
	comboBox->addItem(L"Wichtung per Flächeninhalt",0);
	comboBox->addItem(L"Wichtung per Winkel",0);
	comboBox->addItem(L"Uniforme Wichtung",0);

	GUIEnvironment->addStaticText(L"Anzahl zusätzlicher Detailstufen:", irr::core::rect<irr::s32>(260,235,999,999), false, false, fenster);
...
void DunGen::CGUI::ErstelleFenster_Gaenge()
{
    ...
    irr::gui::IGUIWindow* fenster = GUIEnvironment->addWindow(irr::core::rect<irr::s32>(100,50,700,615),
                false, L"Gänge", 0, _GUI_ID_WINDOW_GAENGE_);
	...
	GUIEnvironment->addButton(irr::core::rect<irr::s32>(10,230,125,245),fenster,_GUI_ID_BUTTON_NEU_GANGPUNKT_,L"Punkt hinzufügen");
	GUIEnvironment->addButton(irr::core::rect<irr::s32>(125,230,240,245),fenster,_GUI_ID_BUTTON_LOESCHEN_GANGPUNKT_,L"Punkt löschen");
	...
	GUIEnvironment->addButton(irr::core::rect<irr::s32>(10,310,240,330),fenster,_GUI_ID_BUTTON_UEBERNEHMEN_GANGPUNKT_,L"Änderungen übernehmen");
	...
	GUIEnvironment->addStaticText(L"Texturkoordinate Y Erhöhung pro Abstand 1 :", irr::core::rect<irr::s32>(10,365,999,999), false, false, fenster);
	GUIEnvironment->addEditBox(L"", irr::core::rect<irr::s32>(200,360,240,380), true, fenster, _GUI_ID_EDITBOX_TEXTUREY_ERHOEHUNG_);

	GUIEnvironment->addStaticText(L"Anzahl zusätzlicher Detailstufen:", irr::core::rect<irr::s32>(10,395,999,999), false, false, fenster);
	...
	GUIEnvironment->addButton(irr::core::rect<irr::s32>(10,465,240,480),fenster,_GUI_ID_BUTTON_DATEI_WAEHLEN_GANGTEXTUR_,L"Texturdatei auswählen");
	...
	GUIEnvironment->addButton(irr::core::rect<irr::s32>(260,230,425,245),fenster,_GUI_ID_BUTTON_NEU_DETAILOBJEKT_,L"Detailobjekt hinzufügen");
	GUIEnvironment->addButton(irr::core::rect<irr::s32>(425,230,590,245),fenster,_GUI_ID_BUTTON_LOESCHEN_DETAILOBJEKT_,L"Detailobjekt löschen");
	...
	GUIEnvironment->addStaticText(L"Faktor für Num Abstand:", irr::core::rect<irr::s32>(260,385,999,999), false, false, fenster);
	...
	GUIEnvironment->addButton(irr::core::rect<irr::s32>(260,505,590,525),fenster,_GUI_ID_BUTTON_UEBERNEHMEN_DETAILOBJEKT_,L"Änderungen übernehmen");
...
void DunGen::CGUI::ErstelleFenster_Architekt()
{
	...
	GUIEnvironment->addStaticText(L"Minimalabstand Raum<->Höhle (für Verbindung):", irr::core::rect<irr::s32>(10,105,999,999), false, false, fenster);
	...
	GUIEnvironment->addStaticText(L"Tiefe für Abstandstest:", irr::core::rect<irr::s32>(10,150,999,999), false, false, fenster);
	...
	GUIEnvironment->addStaticText(L"zusätzliche Ausfrästiefe:", irr::core::rect<irr::s32>(10,175,999,999), false, false, fenster);
	GUIEnvironment->addEditBox(L"", irr::core::rect<irr::s32>(200,170,240,190), true, fenster, _GUI_ID_EDITBOX_ARCHITEKT_AUSFRAESTIEFE_);

	GUIEnvironment->addStaticText(L"Zusätz.Sicherheitsabst. Kollisionstest Gang<->Höhle:", irr::core::rect<irr::s32>(10,200,999,999), false, false, fenster);
	...
	GUIEnvironment->addStaticText(L"Wahrscheinlichkeit für zusätzlichen Gang:", irr::core::rect<irr::s32>(10,230,999,999), false, false, fenster);
	GUIEnvironment->addStaticText(L"Raum<->Höhle:", irr::core::rect<irr::s32>(20,250,999,999), false, false, fenster);
	...
	GUIEnvironment->addStaticText(L"Platzierungswahrscheinlichkeitsfaktor für leere Subszene:", irr::core::rect<irr::s32>(10,275,999,999), false, false, fenster);
	GUIEnvironment->addStaticText(L"an Höhle:", irr::core::rect<irr::s32>(40,295,999,999), false, false, fenster);
	...
	GUIEnvironment->addButton(irr::core::rect<irr::s32>(260,230,425,245),fenster,_GUI_ID_BUTTON_NEU_SUBSZENE_,L"Subszene hinzufügen");
	GUIEnvironment->addButton(irr::core::rect<irr::s32>(425,230,590,245),fenster,_GUI_ID_BUTTON_LOESCHEN_SUBSZENE_,L"Subszene löschen");
	...
	GUIEnvironment->addStaticText(L"an Höhle:", irr::core::rect<irr::s32>(290,340,999,999), false, false, fenster);
	...
	GUIEnvironment->addStaticText(L"Stärke der Gangsplineableitungen:", irr::core::rect<irr::s32>(260,365,999,999), false, false, fenster);
	...
	GUIEnvironment->addStaticText(L"Raum->Höhle:", irr::core::rect<irr::s32>(380,385,999,999), false, false, fenster);
	...
	GUIEnvironment->addStaticText(L"Höhle->Raum:", irr::core::rect<irr::s32>(490,385,999,999), false, false, fenster);
	...
	GUIEnvironment->addButton(irr::core::rect<irr::s32>(260,415,590,435),fenster,_GUI_ID_BUTTON_UEBERNEHMEN_SUBSZENE_,L"Änderungen übernehmen");
...
void DunGen::CGUI::ErstelleFenster_Erstellung()
{
	...
	GUIEnvironment->addStaticText(L"Welche Dungeon-Erstellungschritte sollen ausgeführt werden?", irr::core::rect<irr::s32>(10,25,999,999), false, false, fenster);
	GUIEnvironment->addCheckBox(true,irr::core::rect<irr::s32>(10,40,240,60),fenster,_GUI_ID_CHECKBOX_ERSTELLUNG_FRAKTALZEICHENANWEISUNG_,L"1.) Höhlen-Zeichenanweisung erstellen");
	GUIEnvironment->addCheckBox(true,irr::core::rect<irr::s32>(10,60,240,80),fenster,_GUI_ID_CHECKBOX_ERSTELLUNG_VOXELZEICHNEN_EROSION_,L"2.) Voxelhöhle zeichnen & evntl. Erosion durchführen");
	...
	GUIEnvironment->addCheckBox(true,irr::core::rect<irr::s32>(10,100,240,120),fenster,_GUI_ID_CHECKBOX_ERSTELLUNG_ARCHITEKT_,L"4.) Architekt: Gänge und Räume platzieren");
	...
	GUIEnvironment->addCheckBox(true,irr::core::rect<irr::s32>(10,140,240,160),fenster,_GUI_ID_CHECKBOX_ERSTELLUNG_UMWANDLUNGVOXEL_,L"6.) Umwandlung Voxelhöhle -> Dreicksmesh");
...
void DunGen::CGUI::ErstelleFenster_Weiteres()
{
	...
	GUIEnvironment->addStaticText(L"(Zufallsgenerator für FraktalEditor, Erosion, Architekt)", irr::core::rect<irr::s32>(10,45,999,999), false, false, fenster);
	...
	GUIEnvironment->addStaticText(L"Farbe der Höhle: (0.0 bis 1.0)", irr::core::rect<irr::s32>(10,100,999,999), false, false, fenster);
	...
	GUIEnvironment->addStaticText(L"Grün:", irr::core::rect<irr::s32>(90,120,999,999), false, false, fenster);
	...
	GUIEnvironment->addButton(irr::core::rect<irr::s32>(10,145,240,160),fenster,_GUI_ID_BUTTON_FARBE_HOEHLE_UEBERNEHMEN_,L"Änderungen übernehmen");
	...
	GUIEnvironment->addStaticText(L"Grün:", irr::core::rect<irr::s32>(90,195,999,999), false, false, fenster);
	...
	GUIEnvironment->addButton(irr::core::rect<irr::s32>(10,220,240,235),fenster,_GUI_ID_BUTTON_FARBE_HINTERGRUND_UEBERNEHMEN_,L"Änderungen übernehmen");

	GUIEnvironment->addButton(irr::core::rect<irr::s32>(10,250,240,270),fenster,_GUI_ID_BUTTON_MESHCACHE_TEXTUREBUFFER_LOESCHEN_,L"Meshcache & Texturebuffer (incl. Subszenen) löschen");
...
void DunGen::CGUI::ErstelleFenster_FileOpenDialog(irr::s32 _ID, bool Speichern)
{
	...
	if (Speichern)
		fileOpenDialog = new irr::gui::CGUIFileOpenDialog_Modified(L"Bitte Datei zum Speichern auswählen:", GUIEnvironment, GUIEnvironment->getRootGUIElement(), _ID);
	else
		fileOpenDialog = new irr::gui::CGUIFileOpenDialog_Modified(L"Bitte Datei zum Laden auswählen:", GUIEnvironment, GUIEnvironment->getRootGUIElement(), _ID);
	fileOpenDialog->drop();
