...
unsigned int DunGen::SOctreeKnoten::ZaehleVertices()
{
	...
	// errechnete VertexAnzahl zurückgeben
	return VertexAnzahl;
}
...
// Initialisierung
// ======================================================
__declspec(noinline) DunGen::CDreiecksMesh::CDreiecksMesh(CVoxelRaum* _VoxelRaum, CZufallsGenerator* _ZufallsGenerator, CZeitmesser* _Zeitmesser)
{
	// Werte uebernehmen
