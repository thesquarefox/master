...
namespace DunGen
{
	...
	{
		// Gebietsgrenzen in Voxeln gerechnet (die Octreeknoten-Grenzen, nicht die tatsächliche Ausdehnung!)
		unsigned int GrenzeMinX, GrenzeMaxX, GrenzeMinY, GrenzeMaxY, GrenzeMinZ, GrenzeMaxZ;
	...
	public:
		...
		__declspec(noinline) CDreiecksMesh(CVoxelRaum* _VoxelRaum, CZufallsGenerator* _ZufallsGenerator, CZeitmesser* _Zeitmesser);
